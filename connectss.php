    ...
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="logr"><h1><a href="sign-up.php" class="active"><strong>Sign-up</strong></a></h1></li>
...
$sql="insert into `data`(name,email,subject,building,message)values('$name','$email','$subject','$building','$message')";
  ...
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="row gy-4">
      ...
      <!-- FORM HERE -->
        ...
        <form action="connectss.php" method="post" class="" data-aos="fade-up">
          <div class="row gy-4">
            ...
            <div class="col-md-12">
                  <label for="subject-field" class="pb-2">Building Name</label>
